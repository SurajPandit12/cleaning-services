...
const Hero = () => {
  return (
    <div className="pt-16 md:pt-32">
      <div>
        <div className="bg-[url('/images/end.png')] bg-cover bg-center w-full min-h-[400px] md:min-h-[500px] flex items-center justify-center">
            ...
            <div className="flex flex-col justify-center pl-0 md:pl-6 h-full text-center lg:text-left py-8 lg:py-0">
              <div className="text-white">
                <h2 className="font-montserrat font-bold text-3xl sm:text-4xl md:text-5xl lg:text-[64px] leading-tight md:leading-[50px] lg:leading-[69px]">
                  Stress-Free End of Lease Cleaning
                </h2>
                <p className="font-poppins font-[500] text-lg sm:text-xl md:text-2xl leading-6 sm:leading-7 md:leading-9 py-4 max-w-lg mx-auto lg:mx-0">
                  Secure your bond with a deep, detailed clean — guaranteed.
                </p>
              </div>
